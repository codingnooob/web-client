...
/**
 * Given two RGB arrays (i.e. [255,255,255], [0,0,0]) it calculates the contrast ratio between colors
 * @param {Array} rgb1 i.e. [255,255,255]
 * @param {Array} rgb2 i.e. [0,0,0]
 * @returns {Number}
 */
function calculateContrast(rgb1, rgb2) {
  var lum1 = calculateLuminance(...rgb1);
  var lum2 = calculateLuminance(...rgb2);
